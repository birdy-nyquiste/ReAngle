...
export const es: LocaleEn = {
  ...
  mainApp: {
    ...
    downloadScriptTxt: "Descargar guion (TXT)",
    ...
    voiceoverPlaceholder: "Haz clic en el icono de video para generar el guion, o edita aquí y luego haz clic en Generar avatar.",
    avatarVideoDescription: "Tras generar el guion puedes editarlo (recomendado menos de 700 palabras). Haz clic en \"Generar avatar\" para crear el video; la generación suele tardar unos 5–10 minutos.",
