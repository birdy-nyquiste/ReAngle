...
export const es: LocaleEn = {
  ...
  mainApp: {
    ...
    mustDeangleFirst: "Debes ejecutar Reveal primero.",
    ...
    completeAndContinue: "Completar",
    deangleDescription: "Extrae Eventos y Puntos de vista de la historia, luego verifica la credibilidad de los Eventos",
    startDeangle: "Iniciar Reveal",
    selectedFacts: "Eventos",
    selectedOpinions: "Puntos de vista",
    noEventsSelected: "Ningún evento seleccionado.",
    customization: "Prompts",
    customizationPlaceholder: "Puedes añadir instrucciones sobre longitud, tono, estilo, estructura...",
    ...
    startReangle: "Iniciar Reframe",
    tabDeangle: "Reveal",
    tabReangle: "Reframe",
    runDeangleToShowResult: "Ejecuta Reveal para ver el resultado.",
    runReangleToShowResult: "Ejecuta Reframe para ver el resultado.",
