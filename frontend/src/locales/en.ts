...
export const en = {
  ...
  mainApp: {
    ...
    downloadScriptTxt: "Download Script (TXT)",
    ...
    voiceoverPlaceholder: "Click the video icon above to generate a script first, or edit here then click Generate Avatar.",
    avatarVideoDescription: "After generating the voiceover script, you may edit it as needed (recommended within 700 words). Click \"Generate Avatar\" to create the video, which can then be previewed or downloaded here. Video generation usually takes about 5–10 minutes.",
